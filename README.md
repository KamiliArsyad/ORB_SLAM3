...
Keep in mind that there are some undocumented modifications to the original ORB-SLAM3 system that I did to build it on my computer. If you are curious as to what the modifications are, you can compare this repository with the original ORB-SLAM3 repository at the time it was forked. The rest of the modifications are rather well documented in the codebase which should be self-explanatory if and only if you have a good understanding of the original ORB-SLAM3 system. You can compare my system and the original system using github like this https://github.com/UZ-SLAMLab/ORB_SLAM3/compare/master...KamiliArsyad:ORB_SLAM3:master

The ARCHandler integration I made here is kind of a matured version of my previous one that I did on ORB-SLAM2. You can see that previous code [here](https://github.com/KamiliArsyad/orb-slam2) in case you want to explore the commit history of how I came up with the modifications.
